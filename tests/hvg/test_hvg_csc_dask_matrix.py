"""Canonical consistency matrix: column-chunked CSC dask HVG vs in-memory CSC.

Covers every flavor and both single-batch and batched modes via ARRAY_TYPES
chunk layouts. Absolute / mocked-ooc pins live in ``test_hvg_deterministic_matrix``;
edge cases (layers, rejections, zarr) live in ``test_hvg_csc_dask_edges``.
"""
